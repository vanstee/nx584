...
const (
	...
	ZoneStatusMessageTransitionCapable = message.TransitionCapableYes
	ZoneStatusMessageAcknowledged      = message.AcknowledgedPossible
)
...
func NewZoneStatusMessage(length byte, acknowledgeRequired bool, data []byte) (message.Message, error) {
